...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            lblAvgLocationPrice.Text = Math.Round(db.Location.Average(x => (decimal)x.Price), 2).ToString("F2") + " TL";
            ...
            lblTurkeyCapAvg.Text = db.Location.Where(x => x.Country == "Türkiye").Average(y => y.Capacity).ToString();
